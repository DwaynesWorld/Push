...
final class GradientStrokeProperties: NodePropertyMap, KeypathSearchable {
  ...
  init(gradientStroke: GradientStroke) {
    ...
    self.opacity = NodeProperty(
      provider: KeyframeInterpolator(keyframes: gradientStroke.opacity.keyframes))
    self.startPoint = NodeProperty(
      provider: KeyframeInterpolator(keyframes: gradientStroke.startPoint.keyframes))
    self.endPoint = NodeProperty(
      provider: KeyframeInterpolator(keyframes: gradientStroke.endPoint.keyframes))
    self.colors = NodeProperty(
      provider: KeyframeInterpolator(keyframes: gradientStroke.colors.keyframes))
    self.gradientType = gradientStroke.gradientType
    self.numberOfColors = gradientStroke.numberOfColors
    self.width = NodeProperty(
      provider: KeyframeInterpolator(keyframes: gradientStroke.width.keyframes))
