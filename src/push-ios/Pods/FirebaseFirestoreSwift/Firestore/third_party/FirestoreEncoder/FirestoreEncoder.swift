...
private class _FirestoreEncoder: Encoder {
  ...
  public func container<Key>(keyedBy _: Key.Type) -> KeyedEncodingContainer<Key> {
    ...
    let container = _FirestoreKeyedEncodingContainer<Key>(
...
private struct _FirestoreKeyedEncodingContainer<K: CodingKey>: KeyedEncodingContainerProtocol {
    ...
    -> KeyedEncodingContainer<NestedKey>
  {
    ...
    let container = _FirestoreKeyedEncodingContainer<NestedKey>(
      referencing: encoder,
  ...
  public mutating func nestedUnkeyedContainer(forKey key: Key) -> UnkeyedEncodingContainer {
    ...
    return _FirestoreUnkeyedEncodingContainer(
      referencing: encoder, codingPath: codingPath,
      wrapping: array)
  }

  public mutating func superEncoder() -> Encoder {
    return _FirestoreReferencingEncoder(
      referencing: encoder, at: _FirestoreKey.super,
      wrapping: container)
  }
...
private struct _FirestoreUnkeyedEncodingContainer: UnkeyedEncodingContainer {
  ...
  public mutating func superEncoder() -> Encoder {
    return _FirestoreReferencingEncoder(
      referencing: encoder, at: container.count,
      wrapping: container)
  }
}
