import Foundation
  ...
  private func from(objcPredicate: NMBPredicate) -> Predicate<NSObject> {
    return Predicate { actualExpression in
      let result = objcPredicate.satisfies(
  ...
  internal struct ObjCMatcherWrapper: Matcher {
    ...
    func doesNotMatch(_ actualExpression: Expression<NSObject>, failureMessage: FailureMessage)
      -> Bool
    {
  ...
  public class NMBExpectation: NSObject {
    ...
    @objc public init(
      actualBlock: @escaping () -> NSObject?, negative: Bool, file: FileString, line: UInt
    ) {
    ...
    @objc public var notToWithDescription: (NMBMatcher, String) -> Void {
      return toNotWithDescription
    }
