...
public struct Expression<T> {
  ...
  public init(
    expression: @escaping () throws -> T?, location: SourceLocation, isClosure: Bool = true
  ) {
  ...
  ///                  Swift versions. Nimble internals always sets this true.
  public init(
    memoizedExpression: @escaping (Bool) throws -> T?, location: SourceLocation,
    withoutCaching: Bool, isClosure: Bool = true
  ) {
