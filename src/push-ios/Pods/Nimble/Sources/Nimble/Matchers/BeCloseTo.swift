  ...
  -> PredicateResult
{
  ...
  return PredicateResult(
    bool: actualValue != nil && abs(actualValue!.doubleValue - expectedValue.doubleValue) < delta,
...
///
/// @see equal
public func beCloseTo(_ expectedValue: NMBDoubleConvertible, within delta: Double = DefaultDelta)
  -> Predicate<NMBDoubleConvertible>
{
  ...
  public class NMBObjCBeCloseToMatcher: NSObject, NMBMatcher {
    ...
    @objc public func matches(
      _ actualExpression: @escaping () -> NSObject?, failureMessage: FailureMessage,
  ...
  extension NMBObjCMatcher {
    @objc public class func beCloseToMatcher(_ expected: NSNumber, within: CDouble)
...
public func beCloseTo(_ expectedValues: [Double], within delta: Double = DefaultDelta) -> Predicate<
  [Double]
> {
...
// swiftlint:disable:next identifier_name
public func ≈ (
  lhs: Expectation<NMBDoubleConvertible>, rhs: (expected: NMBDoubleConvertible, delta: Double)
) {
...
// swiftlint:disable:next identifier_name
public func ± (lhs: NMBDoubleConvertible, rhs: Double) -> (
  expected: NMBDoubleConvertible, delta: Double
) {
