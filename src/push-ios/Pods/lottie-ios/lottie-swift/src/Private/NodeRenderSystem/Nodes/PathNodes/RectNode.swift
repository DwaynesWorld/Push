...
final class RectNodeProperties: NodePropertyMap, KeypathSearchable {
  ...
  init(rectangle: Rectangle) {
    ...
    self.position = NodeProperty(
      provider: KeyframeInterpolator(keyframes: rectangle.position.keyframes))
    self.size = NodeProperty(provider: KeyframeInterpolator(keyframes: rectangle.size.keyframes))
    self.cornerRadius = NodeProperty(
      provider: KeyframeInterpolator(keyframes: rectangle.cornerRadius.keyframes))
