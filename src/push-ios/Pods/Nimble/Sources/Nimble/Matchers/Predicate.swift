...
extension Predicate {
  ...
  public static func define(matcher: @escaping (Expression<T>) throws -> PredicateResult)
    -> Predicate<T>
  {
  ...
  public static func define(
    _ msg: String, matcher: @escaping (Expression<T>, ExpectationMessage) throws -> PredicateResult
  ) -> Predicate<T> {
    return Predicate<T> { actual in
  ...
  public static func defineNilable(
    _ msg: String, matcher: @escaping (Expression<T>, ExpectationMessage) throws -> PredicateResult
  ) -> Predicate<T> {
    return Predicate<T> { actual in
      return try matcher(actual, .expectedActualValueTo(msg))
...
extension Predicate {
  ...
  public static func simple(
    _ msg: String, matcher: @escaping (Expression<T>) throws -> PredicateStatus
  ) -> Predicate<T> {
    return Predicate<T> { actual in
...
extension Predicate: Matcher {
  ...
  public static func fromDeprecatedFullClosure(
    _ matcher: @escaping (Expression<T>, FailureMessage, Bool) throws -> Bool
  ) -> Predicate {
  ...
  public static func fromDeprecatedClosure(
    _ matcher: @escaping (Expression<T>, FailureMessage) throws -> Bool
  ) -> Predicate {
    return Predicate { actual in
      let failureMessage = FailureMessage()
  ...
  public static func fromDeprecatedMatcher<M>(_ matcher: M) -> Predicate
  where M: Matcher, M.ValueType == T {
...
extension Predicate {
  ...
  internal func after(f: @escaping (Expression<T>, PredicateResult) throws -> PredicateResult)
    -> Predicate<T>
  {
...
#if canImport(Darwin)
  public typealias PredicateBlock = (_ actualExpression: Expression<NSObject>) throws ->
    NMBPredicateResult
  ...
  public class NMBPredicate: NSObject {
    ...
    func satisfies(_ expression: @escaping () throws -> NSObject?, location: SourceLocation)
      -> NMBPredicateResult
    {
  ...
  extension NMBPredicate: NMBMatcher {
    public func matches(
      _ actualBlock: @escaping () -> NSObject?, failureMessage: FailureMessage,
