...
public indirect enum ExpectationMessage {
  ...
  internal var sampleMessage: String {
    ...
    return
      "(toString(actual:expected:to:) -> \(asStr) || update(failureMessage:) -> \(asFailureMessage.stringValue))"
  }
  ...
  public func replacedExpectation(_ f: @escaping (ExpectationMessage) -> ExpectationMessage)
    -> ExpectationMessage
  {
    // swiftlint:disable:previous identifier_name
