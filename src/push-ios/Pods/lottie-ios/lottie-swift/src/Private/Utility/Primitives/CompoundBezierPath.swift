...
struct CompoundBezierPath {
  ...
  func trim(fromPosition: CGFloat, toPosition: CGFloat, offset: CGFloat, trimSimultaneously: Bool)
    -> CompoundBezierPath
  {
    ...
    if startPosition == 0 && endPosition == 1 || startPosition == endPosition
